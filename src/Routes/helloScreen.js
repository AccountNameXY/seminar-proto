...
                    In Ihrer Mail haben sie Zugriff auf unseren Server erhalten, auf dem die zu testenden Dateien liegen. Es handelt sich hierbei um eine experimentelle Web-Umgebung (später ähnlich eingebunden in Shopware), in der Sie unsere Aufgabe zu einer beispielhaften Erstellung eines Herstellungsprozesses bearbeiten können. Sollten Sie eigene Produkte herstellen oder personalisieren, so können Sie das Web-Tool auch mit Ihren eigenen Produkten testen. Bitte erstellen Sie vor dem Ausfüllen des Fragebogens einen Herstellungsprozess. Ihre Erkenntnisse aus der Erstellung des Herstellungsprozesses werden anschließend erfragt.

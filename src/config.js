...
export const config = {
    Aufgabe: <div>Versuchen Sie folgenden Use Case umzusetzen: <br /> Sie möchten ein neues T-Shirt in ihrem Onlineshop verkaufen. Dabei entstehen folgende Personalisierungsschritte: <br /> 1. Es gibt drei verschiedene Druckarten (Prozessschritt) mit folgenden Subtypen (a) Siebdruck (b) digitaler Direktdruck (c) Bestickt. <br /> 2. Es ist möglich einen Qualitätscheck auszuwählen (Prozessschritt).<br /> 3. Der Nutzer kann sich das T-Shirt als Geschenk verpacken lassen (Prozessschritt).</div>,
